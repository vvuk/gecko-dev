...
{
  return TextureClient::CreateBufferTextureClient(GetForwarder(), aFormat, aTextureFlags);
}
...
CompositableClient::CreateTextureClientForDrawing(SurfaceFormat aFormat,
                                                  TextureFlags aTextureFlags)
{
  return TextureClient::CreateTextureClientForDrawing(GetForwarder(), aFormat, aTextureFlags);
}
